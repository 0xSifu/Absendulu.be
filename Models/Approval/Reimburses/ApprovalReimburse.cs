...
[Table("approvals_reimbursements")]
public class ApprovalReimburse
{
    ...
    [Column("reimburses_name")]
    public string? ReimbursesName { get; set; }
    [Column("reimburses_budget")]
    public double? ReimbursesBudget { get; set; }
    [Column("reimburses_amount")]
    public double? ReimbursesAmount { get; set; }
    // [Column("properties")]
